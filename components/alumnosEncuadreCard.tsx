...
export default function AlumnosEncuadreCard({ encuadreId, materiaNombre, grupo, periodo }: Props) {
  ...
  const handleEnviarCorreo = async (alumno: AlumnoEncuadre, clave?: string) => {
    if (!clave) {
      await confirm({
        title: "Sin clave disponible",
        message: "Para enviar el correo primero debes generar una nueva clave.",
        confirmText: "Entendido",
        cancelText: "",
      });
      return;
    ...
    const shouldSend = await confirm({
      ...
      message: `¿Enviar correo con las credenciales a ${alumno.correo}?`,
      confirmText: "Enviar",
      cancelText: "Cancelar",
    });
    ...
    if (result.success) {
      await confirm({
        ...
        message: "Las credenciales han sido enviadas al alumno.",
        confirmText: "Entendido",
        cancelText: "",
      });
      await cargarAlumnos();
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Registra y administra el acceso de los alumnos a este encuadre
            </CardDescription>
          </div>
      ...
      <CardContent className="space-y-6">
        ...
        {loadingAlumnos ? (
          ...
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p>No hay alumnos registrados en este encuadre</p>
